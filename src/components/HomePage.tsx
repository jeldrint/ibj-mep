      ...
      <section className={`${isInViewport ? 'animate-in delay-700 duration-1.5s fade-in-5 slide-in-from-left-20' : 'invisible'} h-[70vh] bg-cover bg-[20%_0%] w-full md:bg-[10%_30%] bg-blue-400 bg-blend-luminosity`} style={{backgroundImage: `url(${homeImg1})`, }}>
         <div className={`p-9 h-full w-full md:w-[60%] flex flex-col gap-y-5 items-start justify-center`}>
            ...
            <div className='flex gap-x-5'>
               <Link to='/about-us' className='bg-indigo-800 rounded text-slate-200 p-2 hover:duration-1000 hover:bg-slate-400 hover:text-slate-900 hover:animate-in hover:slide-in-from-left-2'>{String.fromCharCode(8594)} MORE ABOUT US</Link>
               <Link to='/our-services' className='bg-indigo-800 rounded text-slate-200 p-2 hover:duration-1000 hover:bg-slate-400 hover:text-slate-900 hover:animate-in hover:slide-in-from-left-2'>{String.fromCharCode(8594)} OUR SERVICES</Link>
            </div>
         </div>
      </section>
