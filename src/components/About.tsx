...
const About = () : React.ReactElement => {
   ...
   return(
      <div key={key} className="w-full h-full">
         {/* ABOUT Header  */}
         <section ref={ref1} className={`${isInViewport1 ? 'animate-in duration-1.5s fade-in-5 slide-in-from-bottom-20' : ''} relative h-[50vh] mb-10 md:mb-20 lg:mb-[150px] bg-cover bg-top lg:bg-[0%_20%] xl:bg-center w-full bg-blue-800 bg-blend-hard-light`} style={{backgroundImage: `url(${pic2})`}}>
            <div className={`${isInViewport1 ? 'animate-in duration-1.5s fade-in-5 slide-in-from-left-10' : ''} absolute p-9 backdrop-blur-sm h-full w-full flex flex-col gap-y-2 items-center justify-center`}>
         ...
         {/* ABOUT Body  */}
         <section className='px-[50px] md:px-[100px] lg:px-[150px] text-justify overflow-hidden'>
            <header className={`${isInViewport1 ? 'animate-in duration-1.5s fade-in-5 slide-in-from-right-10' : ''} inline-block mb-5 p-2 bg-slate-300 text-indigo-800 duration-15 text-4xl font-bold rounded-md`}>
               WHO WE ARE
            </header>
            <br />
            <img className={`${isInViewport2 ? 'animate-in duration-1.5s fade-in-5 slide-in-from-top-20' : ''} float-left mr-5 h-[28vh] sm:h-[30vh] md:h-[40vh] lg:h-[50vh] rounded-md opacity-80`} src={pic4} alt='about-us-pic-1' />
            <div ref={ref2} className={`${isInViewport2 ? 'animate-in duration-1.5s fade-in-5 slide-in-from-right-10' : ''} text-base lg:text-lg`}>
            ...
            <br />
            <div className={`${isInViewport2 ? 'animate-in duration-1.5s fade-in-5 slide-in-from-right-10' : ''} text-base lg:text-lg`}>
            ...
            <img className={`${isInViewport3 ? 'animate-in duration-1.5s fade-in-5 slide-in-from-bottom-20' : ''} float-right ml-5 h-[30vh] sm:h-[35vh] md:h-[40vh] lg:h-[50vh] rounded-md opacity-80`} src={pic5} alt='about-us-pic-1' />
            <div ref={ref3} className={`${isInViewport3 ? 'animate-in duration-1.5s fade-in-5 slide-in-from-left-10' : ''} text-base lg:text-lg`}>
            ...
            <br /><br />
            <div className={`${isInViewport3 ? 'animate-in duration-1.5s fade-in-5 slide-in-from-left-10' : ''} text-base lg:text-lg`}>
         ...
         {/* ABOUT Footer  */}
         <section ref={ref4} className={`${isInViewport4 ? 'animate-in duration-1.5s fade-in-5 slide-in-from-bottom-20' : ''} mt-10 md:mt-20 lg:mt-[150px] relative h-[40vh] bg-cover bg-bottom lg:bg-[0%_85%] w-full bg-blue-800 bg-blend-hard-light`} style={{backgroundImage: `url(${pic2})`}}>
