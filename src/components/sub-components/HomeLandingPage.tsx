...
const HomeLandingPage = () : React.ReactElement => {
   ...
   return (
      <section ref={ref} className={`${isInViewport ? 'animate-in duration-1.5s fade-in-5 slide-in-from-left-20' : 'invisible'} min-h-[100vh] flex items-center justify-start bg-cover bg-[20%_0%] w-full md:bg-[10%_30%] bg-blue-400 bg-blend-luminosity`} style={{backgroundImage: `url(${homeImg1})`, }}>
